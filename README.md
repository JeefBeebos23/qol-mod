...
5. Click Install
6. Open the Minecraft Launcher — you'll see a new "fabric-loader-1.21.4" profile. Select it and launch once to let it set up.
...
Download `qolmod-1.0.0.jar` from this page (it's right here in this folder on GitHub).
...
3. Drop all 3 files into the **mods** folder:
   - `fabric-api-x.x.x+1.21.4.jar`
   - `qolmod-1.0.0.jar`
4. Open the Minecraft Launcher, select the **fabric-loader-1.21.4** profile, and press Play
...
If you also install **Mod Menu** (https://modrinth.com/mod/modmenu/versions?g=1.21.4), you'll get a nice in-game config screen where you can toggle each feature on or off. This is optional — all features are on by default.
...
- Make sure you downloaded Fabric API for **1.21.4** specifically
